...
; example. As the program is written, the knowledge of the currency is distributed 
; partly into the procedure first-denomination and partly into the procedure 
; count-change (which knows that there are ﬁve kinds of U.S. coins). It would be 
...
; to use. We could then have lists that deﬁned each kind of currency: 
;
...
; 292 
; 
; Deﬁne the procedures first-denomination, except-first-denomination, and 
...
(def us-coins-reversed (reverse us-coins))

; Tests
(println (cc 100 us-coins)) ; 292
(println (cc 100 uk-coins)) ; 104561
(println (cc 100 us-coins-reversed)) ; 292
